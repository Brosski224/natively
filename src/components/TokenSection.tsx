...
export default function TokenSection() {
  ...
  return (
    <section
      className="relative overflow-hidden pt-24 pb-32 lg:pt-32 lg:pb-40"
      id="nat-token"
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none opacity-[0.04] z-50 fixed mix-blend-multiply"
        style={{
